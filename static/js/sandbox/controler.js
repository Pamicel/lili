...
animateOnOff = document.getElementById('animateOnOff');
animateOnOff.checked = wg.animate;
animateOnOff.addEventListener('change', () => {
        wg.animate = animateOnOff.checked;
        wg.animateEnd = !wg.animate;
    });
